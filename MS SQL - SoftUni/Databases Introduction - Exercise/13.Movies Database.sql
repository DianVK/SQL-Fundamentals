...
('History','Battle'),
('Drama', 'Avira' ),
('Triller', 'Hills have eyes')

INSERT INTO Movies (Title,DirectorId,CopyrightYear,Length,GenreId,CatgoryId,Rating,Notes)
VALUES(' King' ,5,1999,78,1,5,10,'Excellent'),
('Nine Hills',4,2000,90,2,4,9,'Excellent'),
('Four worlds',3,1980,100,3,3,5,'Excellent'),
('War Ships',2,1890,20,4,2,10,'Good'),
('Robot kid',1,1990,120,5,1,10,'Average')